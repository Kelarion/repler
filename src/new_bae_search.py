...
def _tree_inhib(S, i, j, StS, N, beta):
    ...
    # bae_search.snmf -- so the unstructured prior reproduces the old scaffold bit
...
# reuses `prior` verbatim -- a plain LatentPrior reproduces bae_search.kerbmf3
...
# bae_search.kerbmf3 (feature input) / kerbmf2 (kernel input).  `kernel_input`
