"""
new_bae_search_prior.py  --  PROTOTYPE (factorization sketch)
=============================================================

Extends the compositional search of new_bae_search.py with a THIRD injected
...
Run `python new_bae_search_prior.py` (real src on PYTHONPATH) for the validation:
  [A] no-coupling slab reproduces new_bae_search.snmf_search,
...
# ---------------------------------------------------------------------------
#  LIKELIHOOD link plugins  (unchanged from new_bae_search.py)
# ---------------------------------------------------------------------------
...
# combinatorics, summed over ALL k including k==j, exactly as bae_search.snmf),
...
def _validate():
    import new_bae_search as old          # the current 2-component prototype
