...
#     sparsity_penalty: float = 1e-2
#     tree_penalty: float = 0
#     pr_penalty: float = 1e-2
#     center: bool = False
...
# def bpca(X, r, sparsity_reg=1e-2, tree_reg=0, center=False, **schedule_kwargs):

#     mod = bae_models.BiPCA(r, sparse_reg=sparsity_reg, tree_reg=tree_reg, center=center)
#     neal = bae_util.Neal(**schedule_kwargs)

#     en = neal.fit(X)

#     return mod.S, mod.scl*mod.W, mod.b
