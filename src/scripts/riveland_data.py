...
tpl.matshow(util.group_mean(samps.mean(0), conds, axis=0).T, 
            cmap='binary', color=(0.5,0.5,0.5))
# tpl.matshow(samps.mean(0).T,cmap='binary', color=(0.5,0.5,0.5))
